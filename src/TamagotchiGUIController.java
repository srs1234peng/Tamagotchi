 ...
 */
public class TamagotchiGUIController {
  private TamagotchiModel tamagotchiModel;
  private TamagotchiViewGUI view;
   ...
   */
  public TamagotchiGUIController(TamagotchiModel tamagotchiModel) {
    this.tamagotchiModel = tamagotchiModel;

    // Create an instance of the view and pass a reference to this controller
    this.view = new TamagotchiViewGUI(tamagotchiModel, this);
  ...
  public static void main(String[] args) {
    ...
    new TamagotchiGUIController(tamagotchiModel);
  }
}
